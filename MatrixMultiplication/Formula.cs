...
public sealed class Formula
{
    ...
    public Formula(MatrixMultiplicationShape shape, IEnumerable<ProductTerm> terms)
    {
        Shape = shape;
        Terms = terms;
    }
    ...
    /// <param name="terms">The product terms of the formula.</param>
    public Formula(int n, int m, int p, IEnumerable<ProductTerm> terms)
    {
        Shape = new(n, m, p);
        Terms = terms;
    }
    ...
    /// </summary>
    public IEnumerable<ProductTerm> Terms { get; }
}