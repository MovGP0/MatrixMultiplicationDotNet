...
using FormulaLocator = MatrixMultiplication.Utils.FormulaLocator;

namespace MatrixMultiplication.Tests.Utils;

public static class FormulaLocatorTests
{
    public sealed class BuildFormulaTests
    {
        ...
        {
            // Arrange
            var formula = FormulaLocator.BuildFormula(n, m, p);
    ...
    public sealed class Build4x4x4TPUFormulaTests
    {
        ...
        {
            // Arrange
            var formula = AlphaTensor_4x4x4.Build4x4x4TPUFormula();
        ...
        {
            // Arrange
            var formula = AlphaTensor_4x4x4.Build4x4x4GPUFormula();
            const int n = 4, m = 4, p = 4;
        ...
        [Fact]
        public void ShouldBuild5x5x5Formula()
        {
            // Arrange
            var formula = AlphaTensor_5x5x5.Build5x5x5Formula();
